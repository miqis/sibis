...
CREATE TABLE inventaris.PEMBELIAN (id BIGINT NOT NULL, NAME VARCHAR(40) NOT NULL, NOTES VARCHAR(4000), version BIGINT NOT NULL, PRIMARY KEY (id))
ALTER TABLE simple.SIMPLEOBJECT ADD CONSTRAINT SimpleObject__name__UNQ UNIQUE (NAME)
ALTER TABLE inventaris.PEMBELIAN ADD CONSTRAINT pembelian__name__UNQ UNIQUE (NAME)
