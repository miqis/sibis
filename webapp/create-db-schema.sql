...
CREATE TABLE inventaris.BIAYA (id BIGINT NOT NULL, NONOTA VARCHAR(20) NOT NULL, NOTES VARCHAR(4000), version BIGINT NOT NULL, PRIMARY KEY (id))
...
ALTER TABLE inventaris.BIAYA ADD CONSTRAINT masuk__name__UNQ UNIQUE (NAME)
