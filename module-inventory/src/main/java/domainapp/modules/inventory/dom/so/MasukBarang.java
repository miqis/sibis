...
@javax.persistence.Table(
    schema="inventaris",
    uniqueConstraints = {
        @javax.persistence.UniqueConstraint(name = "masukBarang__name__UNQ", columnNames = {"NAME"})
    }
)
//@javax.persistence.NamedQueries({
//        @javax.persistence.NamedQuery(
//                name = MasukBarang.NAMED_QUERY__FIND_BY_NAME_LIKE,
//                query = "SELECT so " +
//                        "FROM Pengeluaran so " +
...
@DomainObject(logicalTypeName = "inventaris.masukBarang", entityChangePublishing = Publishing.ENABLED)
@DomainObjectLayout()
@NoArgsConstructor(access = AccessLevel.PUBLIC)
@XmlJavaTypeAdapter(PersistentEntityAdapter.class)
@ToString(onlyExplicitlyIncluded = true)
public class MasukBarang implements Comparable<MasukBarang> {
    ...
    // constructor
    public static MasukBarang withName(String name) {
        val simpleObject = new MasukBarang();
    ...
    private final static Comparator<MasukBarang> comparator =
            Comparator.comparing(MasukBarang::getNoNota);

    @Override
    public int compareTo(final MasukBarang other) {
