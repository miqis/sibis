...
@javax.persistence.Table(
    schema="inventaris",
    uniqueConstraints = {
        @javax.persistence.UniqueConstraint(name = "gudang__name__UNQ", columnNames = {"NAME"})
    }
)
//@javax.persistence.NamedQueries({
//        @javax.persistence.NamedQuery(
//                name = Gudang.NAMED_QUERY__FIND_BY_NAME_LIKE,
//                query = "SELECT so " +
//                        "FROM Pengeluaran so " +
...
@DomainObject(logicalTypeName = "inventaris.gudang", entityChangePublishing = Publishing.ENABLED)
@DomainObjectLayout()
...
public class Gudang implements Comparable<Gudang> {
    ...
    // constructor
    public static Gudang withName(String name) {
        val simpleObject = new Gudang();
    ...
    private final static Comparator<Gudang> comparator =
            Comparator.comparing(Gudang::getNoNota);

    @Override
    public int compareTo(final Gudang other) {
